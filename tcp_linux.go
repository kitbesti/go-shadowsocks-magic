...
func redirLocal(addr, server string, shadow func(net.Conn) net.Conn) {
	...
	tcpLocalMagic(addr, server, shadow, func(c net.Conn) (socks.Addr, error) { return getOrigDst(c, false) })
}
...
func redir6Local(addr, server string, shadow func(net.Conn) net.Conn) {
	...
	tcpLocalMagic(addr, server, shadow, func(c net.Conn) (socks.Addr, error) { return getOrigDst(c, true) })
}
